...
export default {
  ...
  [MUTATION_TYPES.REGISTER_TRONWEB_INSTANCE] (state, payload) {
    const result = payload.result

    const tronWebCopy = state.tronWeb
    tronWebCopy.instance = () => result.web3
    tronWebCopy.address = result.address ? result.address.toString() : tronWebCopy.address
    tronWebCopy.coinbase = result.coinbase ? result.coinbase.toString() : tronWebCopy.coinbase
    tronWebCopy.networkId = result.networkId ? result.networkId.toString() : tronWebCopy.networkId
    tronWebCopy.error = result.web3Error ? result.web3Error : tronWebCopy.error
    tronWebCopy.isInjected = result.hasInjectedTronWeb ? result.hasInjectedTronWeb : tronWebCopy.isInjected

    state.tronWeb = tronWebCopy
